...
def add_medical_exam_buttons():
    with st.expander("Medical Licensing Exam Topics 📚", expanded=True):
        ...
        descriptions = {
            "Ultrasound with Doppler 🌊": "Questions related to Doppler Ultrasound imaging techniques 🎥",
            "Oseltamivir 🦠": "Questions about the antiviral medication Oseltamivir 💊",
            "IM Epinephrine 💉": "Questions related to intramuscular administration of epinephrine 💪",
            "Hypokalemia 🍌": "Questions pertaining to low potassium levels in blood 🩸",
            "Succinylcholine 💊": "Questions on the use and side-effects of Succinylcholine 🚑",
            "Testicular Torsion 🤕": "Questions related to the diagnosis and treatment of testicular torsion 🏥",
            "Phosphoinositol System 🧬": "Questions about the Phosphoinositol signalling system 🛠",
            "Ramipril 💊": "Questions related to the ACE inhibitor Ramipril 🩺"
        }
        ...
        if col6.button("Testicular Torsion 🤕"):
            StreamLLMChatResponse(descriptions["Testicular Torsion 🤕"])

        if col7.button("Phosphoinositol System 🧬"):
            StreamLLMChatResponse(descriptions["Phosphoinositol System 🧬"])

        if col8.button("Ramipril 💊"):
